...
const main = async () => {
  console.log(" | | __ _  ___ ___  ___| |_ ___     ___ ___  _ __  _  ___ _ _ _ ");
  console.log(" | || _` || __| _ || __| __| _ |   |  __| _ || '_ || || _ | '__|");
  console.log(" | | (_| | (_| (_) |__ | ||  __|   | (_| (_) | |_) | |  __| |   ");
  console.log(" |_||__,_||___|___||___||__|___|   |___ |___|| .__/|_||___|_|   ");
  console.log("                                           | |                  ");
  console.log("                                           |_|                  ");
  await sleep(500);
  console.log ("");
  console.log ("Made by Aggeloukos.lua#2973");
  await sleep(1000);
  console.log ("");
  console.log ("");
  console.log ("");
  console.log ("WARNING!!! MAKE SURE YOUR DΙSCORD ACCOUNT T0KEN IS NEW AND THE PASSWORD DIDN'T CHANGE,");
  console.log ("OTHERWISE THE T00L WILL NOT WORK CORRECTLY");
  console.log ("");
  console.log ("");
  console.log ("");
  console.log ("");
